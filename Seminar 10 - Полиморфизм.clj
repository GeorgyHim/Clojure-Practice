...
"Тут происходит объявление мультиметода diet, а также его dispatch-функции"
"Эта функция определяет какая ветвь будет вызываться на основе того, какое значение имеет ключ :eater"
